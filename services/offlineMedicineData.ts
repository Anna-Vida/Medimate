...
const GENERATED_OFFLINE_MEDICINES =
...
export const ALL_OFFLINE_MEDICINES: OfflineMedicineRecord[] = [
  ...OFFLINE_MEDICINES,
  ...GENERATED_OFFLINE_MEDICINES,
];

export function getOfflineMedicineCount(): number {
  return ALL_OFFLINE_MEDICINES.length;
}

export function getGeneratedOfflineMedicineCount(): number {
  return GENERATED_OFFLINE_MEDICINES.length;
}
