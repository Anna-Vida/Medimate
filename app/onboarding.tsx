...
const slides = [
  {
    ...
    subtitle:
      "Point your camera at any prescription or medicine packaging. Our AI instantly identifies it and tells you what you need to know.",
    badge: "AI-Powered",
  ...
  },
  {
    ...
    title: "Emergency SOS",
    subtitle:
      "One tap sends your GPS location to your emergency contacts. Your Medical ID card is always ready for first responders.",
    badge: "Always Ready",
    badgeColor: "#FCA5A5",
  },
  {
    ...
    subtitle:
      "Never miss a dose. Your medication history, daily schedule, and drug interaction alerts — all in one place.",
    badge: "Stay Safe",
    badgeColor: Colors.primaryBg,
  },
];
    ...
    <View style={styles.root}>
      ...
      <View style={styles.bottomCard}>
          ...
          {slides.map((_, i) => (
            <View
              ...
              style={[
                styles.dot,
                i === current
                  ? { width: 24, backgroundColor: Colors.primaryDark }
        ...
        <TouchableOpacity onPress={handleNext} activeOpacity={0.85}>
          <View
            style={[styles.ctaBtn, { backgroundColor: Colors.primaryDark }]}
          >
