    ...
    return (
      ...
      >
        <View
          style={[
            styles.severityDot,
            { backgroundColor: getSeverityColor(primaryWarning) },
          ]}
        />
        ...
        <View style={styles.pickerCard}>
          ...
          >
            <View style={styles.timeSelectRow}>
              ...
              <View style={styles.amPmCol}>
                <TouchableOpacity
                  ...
                  style={[styles.amPmBox, isAm && styles.amPmSelected]}
                  activeOpacity={0.7}
                >
                  <Text
                    style={[styles.amPmLabel, isAm && styles.amPmLabelSelected]}
                  >
                    AM
                  </Text>
                </TouchableOpacity>
            ...
            <Text style={styles.toneLabel}>
              <Ionicons name="notifications" size={14} color="#64748B" /> ALARM
              SOUND
            </Text>
          ...
          <View style={styles.pickerBtnRow}>
            <TouchableOpacity style={styles.pickerBtnCancel} onPress={onClose}>
              <Text style={styles.pickerBtnTextCancel}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.pickerBtnConfirm}
              onPress={handleConfirm}
            >
              <Text style={styles.pickerBtnTextConfirm}>Save</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
  ...
  >
    ...
    >
      ...
      >
          ...
          renderItem={({ item }) => {
            ...
            return (
              ...
              >
                ...
                {item.code === "fil-PH" &&
                  item.geminiName !== "Filipino/Tagalog" && (
                    <View
                      style={{
        ...
        >
          <Text style={{ fontWeight: "600", color: "#64748B", fontSize: 15 }}>
            Cancel
          </Text>
        </TouchableOpacity>
      </View>
...
export default function Scanner() {
  ...
  const [generatedOfflineCount, setGeneratedOfflineCount] = useState(0);
  ...
  const [selectedMedForReminder, setSelectedMedForReminder] =
  ...
  useEffect(() => {
    const task = InteractionManager.runAfterInteractions(() => {
      // Defer heavy local JSON parse/index build until after first UI paint.
      setGeneratedOfflineCount(getGeneratedOfflineMedicineCount());
      setOfflineCount(getOfflineMedicineCount());
      warmOfflineMedicineLookupIndexes();
    });
  ...
  const handleSpeak = async (text: string, cardIndex?: number) => {
    try {
      ...
      const ttsLang = ["fil-PH"].includes(selectedLang.code)
        ? "en-US"
        : selectedLang.code;
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      if (!cancelled) {
        const map: Record<
          number,
          { name: string; purpose: string; warnings: string }
        > = {};
    ...
    const subscription = Notifications.addNotificationReceivedListener(
      (notification) => {
        ...
        if (toneId !== "silent") {
          ...
          if (urgency) {
            setTimeout(() => {
              Speech.speak(`Reminder: take ${medicineName} now.`, {
                rate: 1.1,
              });
            }, 5000);
          }
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.permContainer}>
          ...
          <Text style={styles.permDesc}>
            Allow access to scan your medicine.
          </Text>
    ...
    <View style={styles.container}>
        ...
        <View style={styles.container}>
                ...
                >
                  ...
                  {interactionReport && interactionReport.hasConflict && (
                    <View
                      style={[
                        styles.alertBanner,
                        interactionReport.severity === "high"
                          ? styles.alertHigh
                          : styles.alertMedium,
                      ]}
                    >
                  ...
                  {isTranslatingAll && (
                    ...
                    >
                      ...
                      >
                        Translating to{" "}
                        {selectedLang.label.split(" ").slice(1).join(" ")}...
                      </Text>
                    </View>
                  )}
                  {results.map((med, index) => {
                    ...
                    if (fraud) {
                      if (fraud.riskLevel === "high-risk") {
                        ...
                        badgeText = `${fraud.authenticityScore}% Auth`;
                      }
                    }
                    return (
                      <View key={index} style={styles.medCard}>
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            setExpandedMedIndex(isExpanded ? null : index)
                          }
                          activeOpacity={0.7}
                        >
                          ...
                          <View style={styles.medCardBody}>
                            ...
                            <View style={styles.sectionCard}>
                              <View style={styles.cardHeader}>
                                ...
                                <TouchableOpacity
                                  onPress={() => handleSpeak(displayPurpose)}
                                  style={styles.ttsBtn}
                                >
                                  <Ionicons
                                    name="volume-medium"
                                ...
                                {med.signatureVerified && (
                                  <View style={styles.rxSignedBadge}>
                                    <Ionicons
                                      ...
                                      color="#059669"
                                    />
                                    <Text style={styles.rxSignedText}>
                                      Signed
                                    </Text>
                                  </View>
                                )}
                        ...
                        {displayWarnings && displayWarnings.length > 0 && (
                          <View style={styles.warningCardClean}>
                            <View style={styles.warningHeaderRow}>
                              ...
                              <Text style={styles.warningTitleClean}>
                                Safety Warnings
                              </Text>
                              <TouchableOpacity
                                onPress={() =>
                            ...
                            {Array.isArray(displayWarnings) ? (
                              ...
                              <Text style={styles.warningTextClean}>
                                {med.warnings}
                              </Text>
                            )}
                          </View>
                              ...
                              <View style={styles.seniorDiscountCard}>
                                <View style={styles.seniorDiscountBadge}>
                                  <Ionicons
                                    ...
                                    color="#FFF"
                                  />
                                  <Text style={styles.seniorDiscountBadgeText}>
                                    SENIOR / PWD
                                  </Text>
                                </View>
                                <Text
                                  style={styles.seniorDiscountText}
                                  numberOfLines={1}
                                >
                                  20% Off & Priority Lane
                                </Text>
                              </View>
                            )}
                            {med.affordability.philHealthCoverage && (
                              <View style={styles.philhealthCard}>
                                <Ionicons
                                  ...
                                  color="#059669"
                                />
                                <Text style={styles.philhealthText}>
                                  PhilHealth:{" "}
                                  {med.affordability.philHealthCoverage}
                                </Text>
                              </View>
          ...
          {results.length === 0 && !error && !isAnalyzing && (
            <View style={styles.bottomActions}>
              ...
              >
                <Ionicons
                  name={scanMode === "prescription" ? "document-text" : "scan"}
                  size={32}
                  color="#FFF"
                />
              </TouchableOpacity>
              <Text style={styles.instructionText}>
                {scanMode === "prescription"
                  ? "Tap to read prescription"
                  : "Tap to identify pill or box"}
              </Text>
            </View>
          )}
        </View>
              ...
              <View style={styles.modeToggleContainer}>
                <TouchableOpacity
                  style={[
                    ...
                    scanMode === "pill" && styles.modeToggleActive,
                  ]}
                ...
                >
                  ...
                  <Text
                    style={[
                      ...
                      scanMode === "pill" && styles.modeToggleTextActive,
                    ]}
                  >
                    Pills
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.modeToggleBtn,
                    scanMode === "prescription" && styles.modeToggleActive,
                  ]}
            ...
            <View style={styles.bottomControls}>
              ...
              >
                <View
                  style={[
                    styles.blurCircle,
                    flash && { backgroundColor: "rgba(255, 215, 0, 0.6)" },
                  ]}
                >
                  <Ionicons
      ...
      <CustomTimePicker
        ...
        onConfirm={(h, m, tone) =>
          ...
          scheduleReminder(
            selectedMedForReminder.medicineName,
            h,
            m,
            false,
            tone,
